...
| :--- | :--- | :--- |
| [`poster_clase_udea.html`](./poster_clase_udea.html) | HTML5 / CSS Imprimible | **Afiche Publicitario y Poster Académico:** Formato vertical de alta resolución (proporción publicitaria y A4 imprimible con `@media print`) para la sesión del Semillero UdeA conducida por La Alquimia (Viernes 2:00 PM – 4:00 PM · Laboratorio Financiero UdeA 19-206 · Despliegue en Testnet & Mainnet · Asistencia con IA). |
